...
DOCKER_GEN_FOLDER = os.environ.get('DOCKER_GEN_FOLDER', 'generated_docker')
WORK_DIR = os.environ.get('WORK_DIR', 'generated_files')
ENV_FOLDER = os.environ.get('ENV_FOLDER', 'generated_env')
...
ACA_REGISTRY_NAME = os.environ.get('ACA_REGISTRY_NAME', '')
ACA_CONTAINER_APP_NAME = os.environ.get('ACA_CONTAINER_APP_NAME', '')
ACA_RESOURCE_GROUP_NAME = os.environ.get('ACA_RESOURCE_GROUP_NAME', '')

AZURE_OPENAI_CHAT_DEPLOYMENT_NAME = os.environ.get('AZURE_OPENAI_CHAT_DEPLOYMENT_NAME', '')
AZURE_OPENAI_TEXT_DEPLOYMENT_NAME = os.environ.get('AZURE_OPENAI_TEXT_DEPLOYMENT_NAME', '')
...
RG_USER_ASSIGNED_IDENTITY_NAME = os.environ.get('RG_USER_ASSIGNED_IDENTITY_NAME', '')
